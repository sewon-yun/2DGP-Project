...
class Room:
    ...
    def draw(self):
        ...
        if self.door:
            ...
            if self.torch:
                if self.torch < 3:
                    self.image_element4.clip_draw(329, 125, 60, 55, self.x - 28 + (self.torch - 1) * 60, self.y + 35, 60, 60)
                    self.font_size_18.draw(self.x - 45 + (self.torch - 1) * 60, self.y + 25, '횃불', (255, 255, 0))
                else:
                    self.image_element4.clip_draw(330, 125, 60, 55, self.x - 28 + (self.torch - 3) * 60, self.y - 30, 60, 60)
                    self.font_size_18.draw(self.x - 45 + (self.torch - 3) * 60, self.y - 40, '횃불', (255, 255, 0))
            if self.box:
                if self.box < 3:
                    self.image_element4.clip_draw(16, 125, 60, 55, self.x - 28 + (self.box - 1) * 60, self.y + 35, 60, 60)
                    self.font_size_18.draw(self.x - 45 + (self.box - 1) * 60, self.y + 25, '상자', (255, 255, 0))
                else:
                    self.image_element4.clip_draw(16, 125, 60, 55, self.x - 28 + (self.box - 3) * 60, self.y - 30, 60, 60)
                    self.font_size_18.draw(self.x - 45 + (self.box - 3) * 60, self.y - 40, '상자', (255, 255, 0))
            if self.swamp:
                if self.swamp < 3:
                    self.image_element.clip_draw(140, 35, 60, 55, self.x - 28 + (self.swamp - 1) * 60, self.y + 37, 60, 60)
                    self.font_size_18.draw(self.x - 40 + (self.swamp - 1) * 60, self.y + 25, '늪', (255, 255, 0))
                else:
                    self.image_element.clip_draw(140, 35, 60, 55, self.x - 28 + (self.swamp - 3) * 60, self.y - 29, 60, 60)
                    self.font_size_18.draw(self.x - 40 + (self.swamp - 3) * 60, self.y - 40, '늪', (255, 255, 0))
            if self.fair_wind:
                if self.fair_wind < 3:
                    self.image_element2.clip_draw(80, 125, 60, 55, self.x - 28 + (self.fair_wind - 1) * 60, self.y + 37, 60, 60)
                    self.font_size_18.draw(self.x - 45 + (self.fair_wind - 1) * 60, self.y + 25, '순풍', (255, 255, 0))
                else:
                    self.image_element2.clip_draw(80, 125, 60, 55, self.x - 28 + (self.fair_wind - 3) * 60, self.y - 27, 60, 60)
            ...
            if self.electric_current:
                if self.electric_current < 3:
                    self.image_element5.clip_draw(140, 293, 60, 55, self.x - 28 + (self.electric_current - 1) * 60, self.y + 37, 60, 60)
                    self.font_size_18.draw(self.x - 45 + (self.electric_current - 1) * 60, self.y + 25, '전류', (255, 255, 0))
                else:
                    self.image_element5.clip_draw(141, 293, 60, 55, self.x - 28 + (self.electric_current - 3) * 60, self.y - 29, 60, 60)
                    self.font_size_18.draw(self.x - 45 + (self.electric_current - 3) * 60, self.y - 40, '전류', (255, 255, 0))
